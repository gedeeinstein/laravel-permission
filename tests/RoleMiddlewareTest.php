...
class RoleMiddlewareTest extends TestCase
{
    ...
    {
        $this->assertSame(
            'GedeAdi\Permission\Middleware\RoleMiddleware:testAdminRole',
            RoleMiddleware::using('testAdminRole')
        );
        $this->assertEquals(
            'GedeAdi\Permission\Middleware\RoleMiddleware:testAdminRole,my-guard',
            RoleMiddleware::using('testAdminRole', 'my-guard')
        );
        $this->assertEquals(
            'GedeAdi\Permission\Middleware\RoleMiddleware:testAdminRole|anotherRole',
